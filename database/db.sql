...
DROP SCHEMA IF EXISTS `testmysql` ;
CREATE SCHEMA IF NOT EXISTS `testmysql` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci ;
USE `testmysql` ;

-- -----------------------------------------------------
-- Table `testmysql`.`t_file`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `testmysql`.`t_file` ;

CREATE  TABLE IF NOT EXISTS `testmysql`.`t_file` (
  `id` INT NOT NULL ,
...
-- -----------------------------------------------------
-- Table `testmysql`.`t_user`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `testmysql`.`t_user` ;

CREATE  TABLE IF NOT EXISTS `testmysql`.`t_user` (
  `id` INT NOT NULL ,
  ...
  CONSTRAINT `fk_t_user_t_file1`
    ...
    REFERENCES `testmysql`.`t_file` (`id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `testmysql`.`t_address`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `testmysql`.`t_address` ;

CREATE  TABLE IF NOT EXISTS `testmysql`.`t_address` (
  `id` INT NOT NULL ,
  `addr_type` INT NULL ,
...
-- -----------------------------------------------------
-- Table `testmysql`.`t_room`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `testmysql`.`t_room` ;

CREATE  TABLE IF NOT EXISTS `testmysql`.`t_room` (
  `id` INT NOT NULL ,
  ...
  CONSTRAINT `fk_t_room_t_address`
    FOREIGN KEY (`addr_id` )
    REFERENCES `testmysql`.`t_address` (`id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  ...
  CONSTRAINT `fk_t_room_t_user1`
    ...
    REFERENCES `testmysql`.`t_user` (`id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `testmysql`.`t_room_user_relation`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `testmysql`.`t_room_user_relation` ;

CREATE  TABLE IF NOT EXISTS `testmysql`.`t_room_user_relation` (
  `id` INT NOT NULL ,
  `room_id` INT NULL ,
  ...
  CONSTRAINT `fk_t_room_user_relation_t_room1`
    FOREIGN KEY (`room_id` )
    REFERENCES `testmysql`.`t_room` (`id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `testmysql`.`t_follow`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `testmysql`.`t_follow` ;

CREATE  TABLE IF NOT EXISTS `testmysql`.`t_follow` (
  `id` INT NOT NULL ,
