...
class UserInfo : public ::google::protobuf::Message {
 public:
  ...
  inline bool has_pic_id() const;
  inline void clear_pic_id();
  static const int kPicIdFieldNumber = 5;
  inline ::google::protobuf::int32 pic_id() const;
  inline void set_pic_id(::google::protobuf::int32 value);
...
// optional int32 pic_id = 5;
inline bool UserInfo::has_pic_id() const {
  return (_has_bits_[0] & 0x00000010u) != 0;
}
inline void UserInfo::set_has_pic_id() {
  _has_bits_[0] |= 0x00000010u;
}
inline void UserInfo::clear_has_pic_id() {
  _has_bits_[0] &= ~0x00000010u;
}
inline void UserInfo::clear_pic_id() {
  pic_id_ = 0;
  clear_has_pic_id();
}
inline ::google::protobuf::int32 UserInfo::pic_id() const {
  return pic_id_;
}
inline void UserInfo::set_pic_id(::google::protobuf::int32 value) {
  set_has_pic_id();
  pic_id_ = value;
}
