...
//         ret = e.excute("select sender_id,recipient_id,content from t_message where id>" + Tool:mysql_filter(current_id) + " and sender_id = " + sender_id + " and recipient_id=" + Tool:mysql_filter(recipient_id) + " and type='user';");
//         if (ret != DB_OK) {
//             result = DB_ERROR;
