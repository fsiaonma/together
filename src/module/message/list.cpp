...
int get_follow_up_msg(int current_id, int recipient_id, int tid, int type, char *buf, int &send_len) {
    ...
    do {
        ...
        sql = "select id,sender_id,recipient_infod from t_msg where id>" + Tool::mysql_filter(current_id) 
        	+ " and recipient_id=" + Tool::mysql_filter(recipient_id) 
        	+ " and " + right_id + "=" + Tool::mysql_filter(tid) 
...
//         sql = "select sender_id,recipient_id,content from t_msg where id<=" + Tool:mysql_filter(current_id) 
//         	+ " and recipient_id = " + Tool:mysql_filter(recipient_id) 
//             + " and recipient_id=" + Tool:mysql_filter(recipient_id) 
