...
insert into together.t_user (id, username, password, nickname, birthday, signature_text, signature_record_id, praise_num, visit_num) values 
(1, 'admin', 'a', 'G-Mart', 20000101010203, 'hello', 2, 0, 0),
(2, 'admin2', 'a', 'G-Mart2', 20000101010203, 'hello', 2, 0, 0);
